...
# restart_ai_strategy_frontend.sh - Script to restart the AI Strategy Agent frontend

echo "🔄 Restarting AI Strategy Agent Frontend..."
...
FRONTEND_ROOT="$PROJECT_ROOT/applications/ai_strategy_agent/frontend"
cd "$FRONTEND_ROOT"
